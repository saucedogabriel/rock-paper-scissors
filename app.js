...
function gameRound(params) {
    ...
    function getResultIa(params) {
        let result2 = document.querySelector('.section_main__svg-result1');
        let final = 0;
    
        function getRandom() {
            const minCeiled = Math.floor(1);
    ...
    resultIa = getResultIa();
    resultUser = getResultUser();
